/// 1872 Sheffield Rules - Same as 1871
/// Duration: 1872
///
/// No rule changes from 1871
/// Same as 1871 (handling restriction, fair catch abolished)

use crate::sheffield_rules::ruleset::*;

#[derive(Debug, Clone)]
pub struct Ruleset1872;

impl RuleSet for Ruleset1872 {
    fn name(&self) -> &'static str {
        "1872 Sheffield Rules"
    }
